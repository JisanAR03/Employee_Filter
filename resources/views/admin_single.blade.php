        ...
        <div id="myModal" class="fixed top-0 left-0 w-full h-full flex justify-center items-center bg-gray-900 bg-opacity-50 z-50 hidden">
            <div class="bg-white rounded-lg p-8 shadow-md w-[30%] h-[25%] m-auto inset-0 relative mt-[15%]">
                ...
                <div class="text-center mt-8">
                    <p class="text-lg font-semibold mb-4">Click Yes to Delete the Data from List or click No</p>
        ...
        <div class="flex justify-between items-start">
            <div class="shadow-custom pt-8 pb-8 flex flex-col rounded space-y-3 h-fit"
                ...
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-2 px-2 md:px-0" style="padding-left: 2rem; padding-right: 2rem;">
                    <div>
                        <a href="{{ route('exportCsv', ['id' => $id]) }}" class="bg-green-300 hover:bg-green-400 text-gray-600 font-bold py-2 px-4 rounded text-center">Download As CSV</a>
                    </div>
                </div>
                        ...
                        <div class="sfc">
                            <div class='sfc_pagi relative' style="display: none;">
                                ...
                                <div class="inp absolute -right-[20px] top-[50%] -translate-y-[55%]">
                                    <a data-resume="{{$data->id}}" data-list="{{$id}}" class="text-red-500 font-bold text-xl del_list_resume mr-9"><button type="submit" class="data-del-btn bg-red-500 hover:bg-red-700 text-white font-bold rounded-md shadow-md" style="padding: 2px 5px;">X</button></a>
                                </div>
                                {{-- edit button --}}
...
<script>
    ...
    function delete_single_item(){
                ...
                var deleteUrl = "{{ route('delete_data_single', ['dataId' => ':resumeid', 'id' => ':listid']) }}";
                deleteUrl = deleteUrl.replace(':resumeid', currentresumeId);
                deleteUrl = deleteUrl.replace(':listid', currentListId);
                $.get(deleteUrl)
                ...
                $(".del_list_resume").each(function () {
                    $(this).click(function (event) {
                        currentListId = $(this).data("list");
                        currentresumeId = $(this).data("resume");
